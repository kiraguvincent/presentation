...
import com.example.wazitoecommerce.ui.theme.screens.vaccinationrecords.AddVaccinationrecordsScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(ADD_VACCINATIONRECORDS_URL){
            AddVaccinationrecordsScreen(navController = navController)
        }
