...
import com.example.wazitoecommerce.navigation.ADD_DOCTORS_URL
...
fun HomeScreen(navController:NavHostController){
    Column(
        ...
        Button(onClick = {navController.navigate(VIEW_DOCTORS_URL)
        ...
        Button(onClick = {navController.navigate(ADD_DOCTORS_URL)
